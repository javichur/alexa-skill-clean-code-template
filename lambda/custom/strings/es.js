module.exports = {
  ...
  HELP: 'Puedes decirme "hola", "ayuda", "comprobar permisos", "usar api", "guardar sesión", "leer sesión", un color o "stop"',
  HELLO_WORLD: 'Hola Mundo',
  GOODBYE: '¡Hasta luego!',
  HINT_HOME: 'Di "hola", "ayuda", "comprobar permisos", "usar api", "guardar sesión", "leer sesión", un color o "stop"',
